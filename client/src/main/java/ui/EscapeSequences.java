...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_BLACK = SET_BG_COLOR + "30m";
    ...
    public static final String SET_BG_COLOR_BROWN = SET_BG_COLOR + "94m";  // Brown (SaddleBrown)
    public static final String SET_BG_COLOR_BEIGE = SET_BG_COLOR + "180m"; // Beige (Tan)
